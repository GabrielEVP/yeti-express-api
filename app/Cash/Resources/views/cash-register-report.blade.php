                    ...
                    <tbody>
                        @foreach($data['deliveriesByStatus']['delivered'] as $delivery)
                            ...
                            <tr>
                                ...
                                <td
                                    style="{{ isset($delivery['is_anonymous_client']) && $delivery['is_anonymous_client'] ? 'background-color: #FFFF00;' : '' }}">
                                    {{ $delivery['client'] }}</td>
                    ...
                    <tbody>
                        @foreach($data['deliveriesByStatus']['canceled'] as $delivery)
                            <tr>
                                ...
                                <td class="text-right">
                                    ${{ number_format($delivery['total_amount'] ?? $delivery['amount'] ?? 0, 2) }}</td>
                                <td>{{ $delivery['cancellation_notes'] ?? 'Sin motivo' }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
                    ...
                    <tbody>
                        @foreach($data['previousDayPayments'] as $payment)
                            <tr>
                                ...
                                <td>{{ $payment['date'] }}</td>
                                <td
                                    style="{{ isset($payment['is_anonymous_client']) && $payment['is_anonymous_client'] ? 'background-color: #FFFF00;' : '' }}">
                                    {{ $payment['client'] }}</td>
