...
@foreach($period_labels as $index => $label)
    <div class="cash-register-box">
        ...
        <h3 class="section-title">Deliveries Entregados
            ({{ count($period_data[$index]['deliveriesByStatus']['delivered']) }})</h3>
        ...
        <h3 class="section-title">Deliveries Cancelados
            ({{ count($period_data[$index]['deliveriesByStatus']['canceled']) }})</h3>
                ...
                <table>
                    ...
                    @foreach ($deliveriesByStatus['collected'] as $delivery)
                        <tr>
                            ...
                            <td>{{ $delivery['service'] }}</td>
                            <td>${{ number_format($delivery['amount'], 2) }}</td>
                            <td>{{ \App\Helpers\PaymentMethodTranslator::toSpanish($delivery['payment_type']) }}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
